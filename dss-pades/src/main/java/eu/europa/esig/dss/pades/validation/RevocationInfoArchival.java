    ...
    extends ASN1Object
{
    ...
    private RevocationInfoArchival(ASN1Sequence seq)
    {
        ...
        while (e.hasMoreElements())
        {
            ...
            {
                case 0:
                    ASN1Sequence crlValsSeq = (ASN1Sequence)o.getBaseObject().toASN1Primitive();
                    ...
                    break;
                case 1:
                    ASN1Sequence ocspValsSeq = (ASN1Sequence)o.getBaseObject().toASN1Primitive();
                    ...
                    break;
                case 2:
                    this.otherRevVals = OtherRevVals.getInstance(o.getBaseObject().toASN1Primitive());
                    break;
                default:
